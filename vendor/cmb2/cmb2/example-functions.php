...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Test Metabox', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Test Text', 'wp-inci' ),
		'desc'       => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Small', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Read-only Disabled Field', 'wp-inci' ),
		'desc'       => esc_html__( 'field description (optional)', 'wp-inci' ),
		'id'         => 'yourprefix_demo_readonly',
		'type'       => 'text_medium',
		'default'    => esc_attr__( 'Hey there, I\'m a read-only field', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Custom Rendered Field', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Website URL', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Email', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Time', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Time zone', 'wp-inci' ),
		'desc' => esc_html__( 'Time zone', 'wp-inci' ),
		'id'   => 'yourprefix_demo_timezone',
		'type' => 'select_timezone',
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker (UNIX timestamp)', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Money', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Color Picker', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area Small', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area for Code', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Title Weeeee', 'wp-inci' ),
		'desc' => esc_html__( 'This is a title description', 'wp-inci' ),
		'id'   => 'yourprefix_demo_title',
		'type' => 'title',
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Test Select', 'wp-inci' ),
		'desc'             => esc_html__( 'field description (optional)', 'wp-inci' ),
		'id'               => 'yourprefix_demo_select',
		'type'             => 'select',
		'show_option_none' => true,
		'options'          => array(
			'standard' => esc_html__( 'Option One', 'wp-inci' ),
			'custom'   => esc_html__( 'Option Two', 'wp-inci' ),
			'none'     => esc_html__( 'Option Three', 'wp-inci' ),
		),
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Test Radio inline', 'wp-inci' ),
		'desc'             => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Radio', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
		'id'      => 'yourprefix_demo_radio',
		'type'    => 'radio',
		'options' => array(
			'option1' => esc_html__( 'Option One', 'wp-inci' ),
			'option2' => esc_html__( 'Option Two', 'wp-inci' ),
			'option3' => esc_html__( 'Option Three', 'wp-inci' ),
		),
	) );

	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Radio', 'wp-inci' ),
		'desc'     => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Select', 'wp-inci' ),
		'desc'     => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Multi Checkbox', 'wp-inci' ),
		'desc'     => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Checkbox', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Multi Checkbox', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
		'id'      => 'yourprefix_demo_multicheckbox',
		'type'    => 'multicheck',
		// 'multiple' => true, // Store values in individual rows
		'options' => array(
			'check1' => esc_html__( 'Check One', 'wp-inci' ),
			'check2' => esc_html__( 'Check Two', 'wp-inci' ),
			'check3' => esc_html__( 'Check Three', 'wp-inci' ),
		),
		// 'inline'  => true, // Toggles display to inline
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test wysiwyg', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Image', 'wp-inci' ),
		'desc' => esc_html__( 'Upload an image or enter a URL.', 'wp-inci' ),
		'id'   => 'yourprefix_demo_image',
		'type' => 'file',
	) );

	$cmb_demo->add_field( array(
		'name'         => esc_html__( 'Multiple Files', 'wp-inci' ),
		'desc'         => esc_html__( 'Upload or add multiple images/attachments.', 'wp-inci' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'oEmbed', 'wp-inci' ),
		'desc' => sprintf(
			/* translators: %s: link to codex.wordpress.org/Embeds */
			esc_html__( 'Enter a youtube, twitter, or instagram URL. Supports services listed at %s.', 'wp-inci' ),
...
function yourprefix_register_about_page_metabox() {
	...
	$cmb_about_page = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'About Page Metabox', 'wp-inci' ),
		'object_types' => array( 'page' ), // Post type
		'context'      => 'normal',
		'priority'     => 'high',
		'show_names'   => true, // Show field names on the left
...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	$cmb_group = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Repeating Field Group', 'wp-inci' ),
	...
	$group_field_id = $cmb_group->add_field( array(
		...
		'type'        => 'group',
		'description' => esc_html__( 'Generates reusable form entries', 'wp-inci' ),
		'options'     => array(
			'group_title'    => esc_html__( 'Entry {#}', 'wp-inci' ), // {#} gets replaced by row number
			'add_button'     => esc_html__( 'Add Another Entry', 'wp-inci' ),
			'remove_button'  => esc_html__( 'Remove Entry', 'wp-inci' ),
			'sortable'       => true,
	...
	$cmb_group->add_group_field( $group_field_id, array(
		'name'       => esc_html__( 'Entry Title', 'wp-inci' ),
		'id'         => 'title',
		'type'       => 'text',
	...
	$cmb_group->add_group_field( $group_field_id, array(
		'name'        => esc_html__( 'Description', 'wp-inci' ),
		'description' => esc_html__( 'Write a short description for this entry', 'wp-inci' ),
		'id'          => 'description',
		'type'        => 'textarea_small',
	) );

	$cmb_group->add_group_field( $group_field_id, array(
		'name' => esc_html__( 'Entry Image', 'wp-inci' ),
		'id'   => 'image',
		'type' => 'file',
	) );

	$cmb_group->add_group_field( $group_field_id, array(
		'name' => esc_html__( 'Image Caption', 'wp-inci' ),
		'id'   => 'image_caption',
		'type' => 'text',
	) );
...
function yourprefix_register_user_profile_metabox() {
	...
	$cmb_user = new_cmb2_box( array(
		...
		'title'            => esc_html__( 'User Profile Metabox', 'wp-inci' ), // Doesn't output for user boxes
	...
	$cmb_user->add_field( array(
		'name'     => esc_html__( 'Extra Info', 'wp-inci' ),
		'desc'     => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name'    => esc_html__( 'Avatar', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Facebook URL', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Twitter URL', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Google+ URL', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Linkedin URL', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'User Field', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
...
function yourprefix_register_taxonomy_metabox() {
	...
	$cmb_term = new_cmb2_box( array(
		...
		'title'            => esc_html__( 'Category Metabox', 'wp-inci' ), // Doesn't output for term boxes
	...
	$cmb_term->add_field( array(
		'name' => esc_html__( 'Term Image', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
	...
	$cmb_term->add_field( array(
		'name' => esc_html__( 'Arbitrary Term Field', 'wp-inci' ),
		'desc' => esc_html__( 'field description (optional)', 'wp-inci' ),
...
function yourprefix_register_theme_options_metabox() {
	...
	$cmb_options = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Theme Options', 'wp-inci' ),
	...
	$cmb_options->add_field( array(
		'name'    => esc_html__( 'Site Background Color', 'wp-inci' ),
		'desc'    => esc_html__( 'field description (optional)', 'wp-inci' ),
		'id'      => 'bg_color',
		'type'    => 'colorpicker',
		'default' => '#ffffff',
...
function yourprefix_options_page_message_callback( $cmb, $args ) {
	if ( ! empty( $args['should_notify'] ) ) {
		...
		if ( $args['is_updated'] ) {
			...
			$args['message'] = sprintf( esc_html__( '%s &mdash; Updated!', 'wp-inci' ), $cmb->prop( 'title' ) );
		}
...
function yourprefix_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'REST Test Box', 'wp-inci' ),
		'object_types'  => array( 'page' ), // Post type
	...
	$cmb_rest->add_field( array(
		'name'       => esc_html__( 'REST Test Text', 'wp-inci' ),
		'desc'       => esc_html__( 'Will show in the REST API for this box and for pages.', 'wp-inci' ),
		'id'         => 'yourprefix_rest_text',
		'type'       => 'text',
	) );

	$cmb_rest->add_field( array(
		'name'       => esc_html__( 'REST Editable Test Text', 'wp-inci' ),
		'desc'       => esc_html__( 'Will show in REST API "editable" contexts only (`POST` requests).', 'wp-inci' ),
