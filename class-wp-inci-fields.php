...
if (! class_exists('WP_Inci_Fields', false) ) {
    ...
    class WP_Inci_Fields extends WP_Inci
    {
        ...
        public function init()
        {
             ...
             */
            add_action(
                'cmb2_render_switch', array( $this, 'renderSwitch' ),
                10, 5 
            );
            add_action('admin_footer', array( $this, 'adminFooter' ));
            add_action(
                'cmb2_render_search_ajax',
                array( $this, 'renderSearchAjax' ), 10, 5
            );
            add_action(
                'cmb2_sanitize_search_ajax',
                array( $this, 'sanitizeSearchAjax' ), 10, 4
            );
            add_action(
            ...
            add_action(
                'wp_ajax_cmb2_search_ajax_get_results', array(
                $this,
                'cmb2SearchAjaxGetResults'
                ) 
            );
            add_action(
                'wp_ajax_cmb2_multiple_search_ajax_get_results', array(
                $this,
        ...
        public function setupAdminScripts()
        {
            ...
            wp_localize_script(
                'multiple-search-ajax', 'wi_mu', array(
                'ajaxurl' => admin_url('admin-ajax.php'),
        ...
        public function cmb2SearchAjaxGetResults()
        {
            ...
            add_filter(
                'posts_where', array( $this, 'setTitleFilter' ), 10,
                2 
            );
