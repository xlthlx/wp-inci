...
if (! class_exists('WP_Inci', false) ) {
    ...
    class WP_Inci
    {
        ...
        public function init()
        {
             ...
             */
            add_action('init', [ $this, 'postTypeInit' ]);
            add_filter('post_updated_messages', [ $this, 'ingredientUpdatedMessages' ]);
            add_filter('bulk_post_updated_messages', [ $this, 'ingredientBulkUpdatedMessages' ], 10, 2);
            add_filter('post_updated_messages', [ $this, 'productUpdatedMessages' ]);
            add_filter('bulk_post_updated_messages', [ $this, 'productBulkUpdatedMessages' ], 10, 2);
            add_filter('term_updated_messages', [ $this, 'functionUpdatedMessages' ]);
            add_filter('term_updated_messages', [ $this, 'sourceUpdatedMessages' ]);
            add_filter('term_updated_messages', [ $this, 'brandUpdatedMessages' ]);
        }
        ...
        public function ingredientsPostType()
        {
            ...
            register_extended_post_type(
                ...
                'function' => function () {
                    global $post;
                    echo $this->getSafetyHtml($post->ID);
                },
                ),
                'functions' => array(
    ...
    add_action('plugins_loaded', array( 'WP_Inci', 'getInstance' ));
}
