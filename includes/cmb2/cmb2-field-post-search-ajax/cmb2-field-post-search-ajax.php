...
/**
 * This is a modified version of the Plugin to translate the 'No results found' notice.
 */

/**
 * Class CMB2_Field_Post_Search_Ajax
 */
if ( ! class_exists( 'CMB2_Field_Post_Search_Ajax' ) ) {
	...
	class CMB2_Field_Post_Search_Ajax {
		 ...
		 * @param $field_type
		 */
		public function render( $field, $value, $object_id, $object_type, $field_type ): void {
...
$mag_cmb2_field_post_search_ajax = new CMB2_Field_Post_Search_Ajax();
