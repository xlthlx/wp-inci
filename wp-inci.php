...
* @copyright 2024 xlthlx (email: wp-inci at piccioni.london)
...
require_once 'class-wp-inci.php';
require_once 'class-wp-inci-fields.php';

if ( is_admin() ) {
include_once 'admin/class-wp-inci-admin.php';
include_once 'admin/class-wp-inci-meta.php';
} else {
include_once 'public/class-wp-inci-frontend.php';
}

require_once 'blocks/wp-inci-product/class-wp-inci-product.php';